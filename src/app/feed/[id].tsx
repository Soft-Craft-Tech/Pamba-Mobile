  ...
  return (
    <View className="flex-1 p-3 ">
      ...
      <View className="m-2 flex overflow-hidden rounded-xl bg-white px-10 shadow-xl">
        ...
        <View className="my-4 flex w-full  flex-row justify-between rounded-md bg-[#F5F6FA] p-5">
      ...
      <Text className="text-xl">{postData?.comment}</Text>
      <Text>{postData?.create_at} </Text>
    </View>
  );
}
